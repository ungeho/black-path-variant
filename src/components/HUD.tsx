...
import { BOARD_ROWS, BOARD_COLS } from '../game';
...
export function HUD({ state, aiThinking, turnRemaining, aiPlayer, record }: HUDProps) {
  const { phase, currentPlayer, result, moveHistory } = state;
